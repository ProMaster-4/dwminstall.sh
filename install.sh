...
sudo pacman -Syu git firefox zoxide picom lxappearance feh kitty xorg-server xorg-xinit xorg-xrandr base-devel libx11 libxinerama libxft webkit2gtk --noconfirm
